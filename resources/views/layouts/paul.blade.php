...
<body class="font-sans antialiased"
    x-data="{ page: 'route', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
                    ...
                    @if (isset($header))
                        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <ol class="flex items-center gap-2">
                                <li><a class="font-medium text-slate-500" href="{{ route('dashboard') }}">Dashboard /</a></li>
                                <li class="font-medium text-blue-500">{{$header}}</li>
                            </ol>
                            </nav>
                        </div>
                        @endif
