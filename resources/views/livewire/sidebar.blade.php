<aside
  ...
  >
    ...
    <div
      class="flex flex-col overflow-y-auto duration-300 ease-linear scrollbar-hidden no-scrollbar"
    >
      <!-- Sidebar Menu -->
      <nav
      ...
      >
        <!-- Menu Group -->
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-gray-600 dark:text-gray-500">MENU</h3>

          <ul class="mb-6 flex flex-col gap-1.5">
            <!-- Menu Item Dashboard -->
            <li>
              <a
                class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 "
                href="#"
                @click.prevent="selected = (selected === 'Dashboard' ? '':'Dashboard')"
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Dashboard') || (page === 'ecommerce' || page === 'analytics') }"
              >
                <svg
                  class="fill-current"
                  width="18"
                ...
                <x-arrow-line class="absolute -translate-y-1/2 right-4 top-1/2" ::class="{'rotate-180': (selected === 'Dashboard') }" ></x-arrow-line>
              </a>
              ...
              >
                ...
                <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-slate-700 dark:hover:text-white" href="#" :class="page === 'ecommerce' && '!text-white'">eCommerce
                      </a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'analytics' && '!text-white'">Analytics
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'marketing' && '!text-white'">Marketing
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'crm' && '!text-white'">CRM
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                </ul>
              </div>
            ...
            <li>
                <a
                  ...
                  @click="selected = (selected === 'Route' ? '':'Route')"
                  :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Route') && (page === 'route') }"
                  :class="page === 'route' && 'bg-graydark'"
                  wire:navigate
                >
                  <svg
                    class="fill-current"
            ...
            <li>
              <a
                ...
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Profile') && (page === 'profile') }"
            ...
            <li>
              <a
                ...
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Calendar') && (page === 'calendar') }"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <li>
              <a
                ...
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout') }"
              >
                <svg
                  class="fill-current"
                  width="18"
                ...
                Forms
                <x-arrow-line class="absolute -translate-y-1/2 right-4 top-1/2" ::class="{'rotate-180': (selected === 'Forms') }" ></x-arrow-line>
              ...
              >
                <ul class="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                  <li>
                    <a
                      class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white"
                      href="#"
            ...
            <li>
              <a
                ...
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Tables') && (page === 'Tables') }"
              >
                <svg
                  class="fill-current"
                  width="18"
            ...
            <li>
              <a
                ...
                :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Settings') && (page === 'settings') }"
        ...
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-gray-600 dark:text-gray-500">SUPPORT</h3>

          <ul class="mb-6 flex flex-col gap-1.5">
            <!-- Menu Item Messages -->
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click="selected = (selected === 'Messages' ? '':'Messages')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Messages') && (page === 'Messages') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15.7499 2.75208H2.2499C1.29365 2.75208 0.478027 3.53957 0.478027 4.52395V13.6364C0.478027 14.5927 1.26553 15.4083 2.2499 15.4083H15.7499C16.7062 15.4083 17.5218 14.6208 17.5218 13.6364V4.49583C17.5218 3.53958 16.7062 2.75208 15.7499 2.75208ZM15.7499 4.0177C15.778 4.0177 15.8062 4.0177 15.8343 4.0177L8.9999 8.4052L2.16553 4.0177C2.19365 4.0177 2.22178 4.0177 2.2499 4.0177H15.7499ZM15.7499 14.0865H2.2499C1.96865 14.0865 1.74365 13.8615 1.74365 13.5802V5.2552L8.3249 9.47395C8.52178 9.61457 8.74678 9.67083 8.97178 9.67083C9.19678 9.67083 9.42178 9.61457 9.61865 9.47395L16.1999 5.2552V13.6083C16.2562 13.8896 16.0312 14.0865 15.7499 14.0865Z" fill=""></path>
                </svg>

                Messages

                <span class="absolute right-14 top-1/2 -translate-y-1/2 rounded bg-sky-500 py-1 px-2.5 text-xs font-medium text-white">5</span>
                <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span>
              </a>
            </li>
            <!-- Menu Item Messages -->
            ...
            <!-- Menu Item Inbox -->
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click="selected = (selected === 'Inbox' ? '':'Inbox')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Inbox') && (page === 'inbox') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Menu Item Invoice -->
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click="selected = (selected === 'Invoice' ? '':'Invoice')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Invoice') && (page === 'Invoice') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Others Group -->
        <div>
          <h3 class="mb-4 ml-4 text-sm font-medium text-gray-600 dark:text-gray-500">OTHERS</h3>

          <ul class="mb-6 flex flex-col gap-1.5">

                        <!-- Menu Item Chart -->
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click.prevent="selected = (selected === 'Charts' ? '':'Charts')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'Charts') || (page === 'basicChart' || page === 'advancedChart') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <x-arrow-line class="absolute -translate-y-1/2 right-4 top-1/2" ::class="{'rotate-180': (selected === 'Charts') }" ></x-arrow-line>
              ...
              <div class="overflow-hidden transform translate" :class="(selected === 'Charts') ? 'block' :'hidden'">
                <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'basicChart' && '!text-white'">Basic Chart</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'advancedChart' && '!text-white'">Advanced Chart
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                </ul>
              </div>
            ...
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click.prevent="selected = (selected === 'UiElements' ? '':'UiElements')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'UiElements') || (page === 'alerts' || page === 'buttons' || page === 'card' || page === 'tabs' || page === 'modals') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <x-arrow-line class="absolute -translate-y-1/2 right-4 top-1/2" ::class="{'rotate-180': (selected === 'UiElements') }" ></x-arrow-line>
              ...
              <div class="overflow-hidden transform translate" :class="(selected === 'UiElements') ? 'block' :'hidden'">
                <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'alerts' && '!text-white'">Alerts</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'buttons' && '!text-white'">Buttons</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'buttonsGroup' && '!text-white'">Buttons Group
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'badge' && '!text-white'">Badge
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'breadcrumb' && '!text-white'">Breadcrumb
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'card' && '!text-white'">Cards
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'dropdowns' && '!text-white'">Dropdowns
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'Modals' && '!text-white'">Modals
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'tabs' && '!text-white'">Tabs
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'tooltips' && '!text-white'">Tooltips
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'popovers' && '!text-white'">Popovers
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'accordion' && '!text-white'">Accordion
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'notifications' && '!text-white'">Notifications
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'pagination' && '!text-white'">Pagination
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'progress' && '!text-white'">Progress
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'carousel' && '!text-white'">Carousel
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'images' && '!text-white'">Images
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'videos' && '!text-white'">Videos
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                </ul>
              </div>
            ...
            <li>
              <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-gray-600 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400 duration-300 ease-in-out hover:bg-zinc-200 dark:hover:bg-slate-700 " href="#" @click.prevent="selected = (selected === 'AuthPages' ? '':'AuthPages')" :class="{ 'bg-zinc-200 dark:bg-slate-700': (selected === 'AuthPages') || (page === 'register' || page === 'login' || page === 'forgetPassword') }">
                <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_130_9814)">
                    <path d="M12.7127 0.55835H9.53457C8.80332 0.55835 8.18457 1.1771 8.18457 1.90835V3.84897C8.18457 4.18647 8.46582 4.46772 8.80332 4.46772C9.14082 4.46772 9.45019 4.18647 9.45019 3.84897V1.88022C9.45019 1.82397 9.47832 1.79585 9.53457 1.79585H12.7127C13.3877 1.79585 13.9221 2.33022 13.9221 3.00522V15.0709C13.9221 15.7459 13.3877 16.2802 12.7127 16.2802H9.53457C9.47832 16.2802 9.45019 16.2521 9.45019 16.1959V14.2552C9.45019 13.9177 9.16894 13.6365 8.80332 13.6365C8.43769 13.6365 8.18457 13.9177 8.18457 14.2552V16.1959C8.18457 16.9271 8.80332 17.5459 9.53457 17.5459H12.7127C14.0908 17.5459 15.1877 16.4209 15.1877 15.0709V3.03335C15.1877 1.65522 14.0627 0.55835 12.7127 0.55835Z" fill=""></path>
                    <path d="M10.4346 8.60205L7.62207 5.7333C7.36895 5.48018 6.97519 5.48018 6.72207 5.7333C6.46895 5.98643 6.46895 6.38018 6.72207 6.6333L8.46582 8.40518H3.45957C3.12207 8.40518 2.84082 8.68643 2.84082 9.02393C2.84082 9.36143 3.12207 9.64268 3.45957 9.64268H8.49395L6.72207 11.4427C6.46895 11.6958 6.46895 12.0896 6.72207 12.3427C6.83457 12.4552 7.00332 12.5114 7.17207 12.5114C7.34082 12.5114 7.50957 12.4552 7.62207 12.3145L10.4346 9.4458C10.6877 9.24893 10.6877 8.85518 10.4346 8.60205Z" fill=""></path>
                ...
                <x-arrow-line class="absolute -translate-y-1/2 right-4 top-1/2" ::class="{'rotate-180': (selected === 'AuthPages') }" ></x-arrow-line>
              </a>
              ...
              <div class="overflow-hidden transform translate" :class="(selected === 'AuthPages') ? 'block' :'hidden'">
                <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'signin' && '!text-white'">Sign In</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'signup' && '!text-white'">Sign Up</a>
                  </li>
                  <li>
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-gray-600 dark:text-gray-500 duration-300 ease-in-out hover:text-white" href="#" :class="page === 'resetPassword' && '!text-white'">Reset Password
                      <span class="absolute block px-2 py-1 text-xs font-medium text-white rounded right-4 bg-sky-500">Pro</span></a>
                  </li>
                </ul>
              </div>
      ...
      <!-- Promo Box -->
      {{-- <div
        class="w-full px-4 py-6 mx-auto mb-10 text-center border rounded-sm max-w-[15rem] border-slate-300 bg-zinc-200 dark:border-gray-700 dark:bg-slate-800 shadow-default">
        <h3 class="mb-1 font-semibold text-white">Paul</h3>
        <p class="mb-4 text-xs text-slate-500"></p>
        <a href="" target="_blank" rel="nofollow"
          class="flex items-center justify-center p-2 text-white rounded-md bg-sky-500 hover:bg-opacity-95">
          Purchase Now
        </a>
      </div> --}}
      <!-- Promo Box -->
