<header
    class="sticky top-0 flex w-full bg-white border-b dark:bg-gray-800 border-slate-100 dark:border-slate-800 z-[999] drop-shadow-1 dark:drop-shadow-none">
    <div class="flex items-center justify-between flex-grow px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            <!-- Hamburger Toggle BTN -->
            <button
                class="z-99999 block rounded-sm border border-slate-400 bg-white p-1.5 shadow-sm dark:border-slate-700 dark:bg-gray-800 lg:hidden"
                @click.stop="sidebarToggle = !sidebarToggle">
                <span class="relative block w-5 h-5 cursor-pointer">
            ...
            <form action="#" method="POST">
                <div class="relative">
                    <button class="absolute left-0 -translate-y-1/2 top-1/2">
                        <svg class="fill-gray-600 hover:fill-blue-500 dark:fill-gray-500 dark:hover:fill-blue-400"
                    ...
                    <input type="text" placeholder="Type to search..."
                        class="w-full pr-4 bg-transparent border-none outline-none pl-9 xl:w-96 text-slate-500"
                        style="box-shadow: none;" />
                </div>
            </form>
        </div>
{{-- {{__(request()->getSchemeAndHttpHost())}} --}}
        <div class="flex items-center gap-3 2xsm:gap-7">
            <ul class="flex items-center gap-2 2xsm:gap-4">
                <li>
                    <!-- Dark Mode Toggler -->
                    <label :class="darkMode ? 'bg-blue-500' : 'bg-zinc-200'"
                        class="relative block m-0 rounded-full h-7 w-14">
                ...
                <div class="relative">
                    <x-dropdown align="right" width="w-60 sm:w-80"
                        contentClasses="h-96 flex flex-col py-1 bg-white dark:bg-gray-700">
                        <x-slot name="trigger">
                            <div class="relative flex h-8 w-8 items-center justify-center rounded-full border-[0.5px] text-slate-500 border-slate-300 bg-zinc-200 hover:text-blue-500 dark:border-gray-700 dark:bg-slate-700 dark:text-white"
                                x-data="{notifying: true}" @click.prevent="notifying = false">
                                <span :class="!notifying && 'hidden'"
                                    class="absolute -top-0.5 -right-0.5 z-1 h-2 w-2 rounded-full bg-rose-900">
                                    <span
                                        class="absolute inline-flex w-full h-full rounded-full opacity-75 -z-1 animate-ping bg-rose-900"></span>
                                </span>
                        ...
                        <x-slot name="content">
                            <!-- Account Management -->
                            <div class="block px-4 py-2 text-lg text-gray-400">
                                {{ __('Notification') }}
                            </div>
                            ...
                            <div class="flex flex-col h-auto overflow-y-auto">
                                @for ($i=0; $i<5 ;$i++)
                                    <x-dropdown-link href="{{ route('profile.show') }}"
                                        class="flex flex-col gap-2.5 border-t border-gray-200 dark:border-gray-600">
                                        <p class="text-sm">
                ...
                {{-- <li class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                    ...
                    <a class="relative flex h-8 w-8 items-center justify-center rounded-full border-[0.5px] text-slate-500 border-slate-300 bg-zinc-200 hover:text-blue-500 dark:border-gray-700 dark:bg-slate-700 dark:text-white"
                        href="#" @click.prevent="dropdownOpen = ! dropdownOpen; notifying = false">
                        <span :class="!notifying && 'hidden'"
                            class="absolute -top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-rose-900">
                            <span
                                class="absolute inline-flex w-full h-full rounded-full opacity-75 -z-1 animate-ping bg-rose-900"></span>
                        </span>
                    ...
                    <div x-show="dropdownOpen"
                        class="absolute -right-27 mt-2.5 flex h-96 w-80 flex-col rounded-lg border border-slate-300 bg-white shadow-default dark:border-gray-700 dark:bg-slate-800 sm:right-0 sm:w-80">
                        <div class="px-4 py-3">
                            <h5 class="text-sm font-medium text-bodydark2">Notification</h5>
                        </div>

                        <ul
                            class="flex flex-col h-auto overflow-y-auto dark:scrollbar-thumb:!bg-slate-500/50 dark:scrollbar-track:!bg-slate-500/[0.16] lg:supports-scrollbars:pr-2 overflow-hidden scrollbar-thumb:!bg-slate-300 scrollbar-thumb:!rounded scrollbar-track:!bg-slate-100 scrollbar-track:!rounded scrollbar:!h-1.5 scrollbar:!w-1.5 scrollbar:bg-transparent">
                            <li>
                                <a class="flex flex-col gap-2.5 border-t border-slate-300 px-4 py-3 hover:bg-gray-200 dark:border-gray-700 dark:hover:bg-slate-700"
                                    href="#">
                                    <p class="text-sm">
                                        <span class="text-black dark:text-white">Edit your information in a swipe</span>
                                        Sint occaecat cupidatat non proident, sunt in culpa qui
                ...
                <div class="relative">
                    <x-dropdown align="right" width="w-60 sm:w-80"
                        ...
                        <x-slot name="content">
                            ...
                            <div class="flex flex-col h-auto overflow-y-auto">
                                @for ($i=0; $i<5 ;$i++) <x-dropdown-link href="{{ route('profile.show') }}"
                                    class="flex gap-4 border-t border-gray-200 dark:border-gray-600">
                                    <div class="w-12 h-12 rounded-full">
                                        <img class="object-cover rounded-full"
                                            src="{{ Auth::user()->profile_photo_url }}" alt="User" />
                                    </div>
                ...
                {{-- <li class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                    ...
                    <div x-show="dropdownOpen"
                        ...
                        <ul class="flex flex-col h-auto overflow-y-auto">
                            <li>
                                <a class="flex gap-4.5 border-t border-stroke px-4 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                                    href="messages.html">
                                    <div class="w-12 h-12 rounded-full">
            ...
            <div class="relative ms-3">
                <x-dropdown align="right" width="w-80 lg:w-48">
                    <x-slot name="trigger">
                        <div class="flex items-center gap-4">
                            <span class="hidden text-right lg:block">
                                ...
                                <span class="block text-xs font-medium text-slate-500">UX Designer</span>
                            </span>
                            ...
                            <x-arrow-line class="hidden text-slate-500 sm:block" ::class="open && 'rotate-180'">
                            </x-arrow-line>
                        </div>
                    </x-slot>
                    ...
                    <x-slot name="content">
                        ...
                        <div class="lg:hidden">
                            <div class="flex items-center p-4">
                                ...
                                <div class="w-60">
                                    <div class="text-base font-medium text-gray-800 break-words dark:text-gray-200">{{ Auth::user()->name }}</div>
                                    <div class="text-sm font-medium text-gray-500 break-words">{{ Auth::user()->email }}</div>
                                </div>
                            </div>
                            <div class="border-t border-gray-200 dark:border-gray-600"></div>
                        ...
                        <x-dropdown-link href="{{ route('profile.show') }}" wire:navigate class="flex items-center gap-3.5">
                        ...
                        <x-dropdown-link href="{{ route('api-tokens.index') }}" wire:navigate class="flex items-center gap-3.5">
                        ...
                        <x-dropdown-link class="flex items-center gap-3.5">
                            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <x-dropdown-link href="{{ route('logout') }}" class="flex items-center gap-3.5"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        <span class="block text-sm font-medium text-slate-700 dark:text-slate-200">Thomas Anree</span>
                        <span class="block text-xs font-medium text-slate-500">UX Designer</span>
                    </span>
                    ...
                    <x-arrow-line class="hidden text-slate-500 sm:block" ::class="dropdownOpen && 'rotate-180'">
                    </x-arrow-line>
                ...
                <!-- Dropdown Start -->
                <div x-show="dropdownOpen"
                    class="absolute right-0 flex flex-col mt-4 bg-white border rounded-lg w-60 border-slate-300 shadow-default dark:border-gray-700 dark:bg-slate-800">
                    <ul class="flex flex-col gap-5 px-6 border-b border-stroke py-7 dark:border-strokedark">
                        <li>
